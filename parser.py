...
def _resolve_drug(code_system: str, med_code: str,
    ...
    if sys_lower in NDC_SYSTEM_NAMES:
        # ── Step 1: openFDA NDC API (dashed format, direct drug info + RXCUI) ─
        ...
        # ── Step 2: RxNorm NDC→RXCUI (broader coverage for US generics) ──────
        ...
        # ── Step 3: Both APIs failed — local name fallback ────────────────────
